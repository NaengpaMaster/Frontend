      ...
      >
        <div style={{ padding: '18px 20px 14px', borderBottom: `1px solid ${C.border}`, display: 'flex', alignItems: 'center', justifyContent: 'space-between' }}>
          <div>
            ...
            <div style={{ color: C.fg, fontSize: '18px', fontWeight: 900, marginTop: '3px' }}>영수증으로 재료 등록</div>
          </div>
        ...
        <div style={{ padding: '16px 20px', overflowY: 'auto', display: 'flex', flexDirection: 'column', gap: '12px' }}>
          <div style={{ padding: '12px', borderRadius: '16px', background: C.card, border: `1px solid ${C.border}` }}>
            <label style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', gap: '8px', minHeight: '52px', cursor: 'pointer', color: C.primary, fontSize: '13px', fontWeight: 900 }}>
              <Upload size={16} />
              {file ? file.name : 'jpg, jpeg, png 영수증 이미지 선택'}
              <input
                type="file"
