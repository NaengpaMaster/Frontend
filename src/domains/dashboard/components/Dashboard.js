            ...
            .then((page) => {
                ...
                setScoreHistory(page.content.map((item, idx) => {
                    ...
                    const icon = item.scoreReason === 'EXPIRED_PRODUCT'
                        ? CATEGORY_EMOJIS[CATEGORY_NAMES[item.productCategoryId] ?? '기타']
                        : reasonMeta.icon;
                    return {
                        id: idx,
                        icon,
        ...
        <div style={{padding: '0 0 24px', background: C.bg}}>
            ...
            >
                <div>
                    ...
                    <div style={{fontSize: '12px', color: C.fgMuted, marginTop: '2px'}}>안녕하세요, {currentUser.name}님 👋
                    </div>
                </div>
                <div style={{display: 'flex', gap: '8px', alignItems: 'center'}}>
                    ...
                    >
                        <div style={{fontSize: '18px', fontWeight: 900, lineHeight: 1}}>{wasteScore}<span
