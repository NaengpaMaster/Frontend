...
import { User, C, PresetIngredientItem } from '../data/mockData';
...
const HOUSEHOLD_TYPES: User['householdType'][] = ['1인', '2인', '3인 이상', '기타'];
...
export function MyPage({ user, presetIngredients, onClose, onLogout, onUpdate, onDeleteAccount, onOpenAdmin }: MyPageProps) {
