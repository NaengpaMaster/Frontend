...
export function getRecipeMatch(recipe, ingredients) {
...
export const initialPresetIngredients = PRESET_INGREDIENTS.map((item) => ({
  ...item,
  active: true,
}));

export const GRADE_TABLE = [
  { minScore: 0,  maxScore: 19,  label: '냉털 새내기',   emoji: '🥄', range: '0~19점', characterImage: '/grade-characters/newbie.png' },
  { minScore: 20, maxScore: 39,  label: '냉파 수련생',   emoji: '🌱', range: '20~39점', characterImage: '/grade-characters/trainee.png' },
  { minScore: 40, maxScore: 59,  label: '냉장고 탐험가', emoji: '🧭', range: '40~59점', characterImage: '/grade-characters/explorer.png' },
  { minScore: 60, maxScore: 79,  label: '냉파 에이스',   emoji: '⭐', range: '60~79점', characterImage: '/grade-characters/ace.png' },
  { minScore: 80, maxScore: 89,  label: '냉파 고인물',   emoji: '⭐', range: '80~89점', characterImage: '/grade-characters/veteran.png' },
  { minScore: 90, maxScore: 100, label: '냉파 마스터',   emoji: '🏆', range: '90~100점', characterImage: '/grade-characters/master.png' },
];
